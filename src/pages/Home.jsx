...
export default function Home() {
  ...
  <meta 
    name="description" 
    content="Grey Techs provides surveillance camera installation, structured cabling, VoIP phone systems, and IT support for small businesses in Central & Southern Ohio." 
  />
  {/* Open Graph */}
  <meta property="og:title" content="Grey Techs | Reliable Business IT Solutions" />
  <meta 
    property="og:description" 
    content="Trusted local IT partner for surveillance, networking, VoIP, and on-demand support. Serving Central & Southern Ohio with reliable business tech solutions." 
  />
  ...
  <meta name="twitter:description" content="Reliable IT support, surveillance, and network solutions for small businesses in Ohio." />
